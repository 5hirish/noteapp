...
@LargeTest
public class NoteUnCheckCheckTest {
    ...
    @Test
    public void unMarkNoteAndMarkInList() throws Exception {
        ...
        for (String noteContent: inputNotes) {
            onView(ViewMatchers.withId(R.id.rvNoteComplete)).perform(actionOnItem(hasDescendant(withText(noteContent)), ViewHolderViewAction.clickChildViewWithId(R.id.cbNoteMarked)));
        }
